...
tankLand.addGameObject(testingObject)
tankLand.addGameObject(obj2)
tankLand.addGameObject(obj3)
tankLand.addGameObject(obj4)
tankLand.displayGrid() //J4 is at wrong pos!

print("Oh no, J4 is wrong, moving it!!\n")

tankLand.moveObject(obj4, toRow:12, toCol:3)
